...
const Thirdgamecontent = (props) => {
  ...
  const [images, setimages] = useState(() => {
    return [
      {im: props.image1, id: 1, imc: props.trueim1, imghint: props.imghint},
      {im: props.image2, id: 2, imc: props.wrongim2, imghint: props.image2},
      {im: props.image3, id: 3, imc: props.wrongim3, imghint: props.image3},
      {im: props.image4, id: 4, imc: props.wrongim4, imghint: props.image4},
